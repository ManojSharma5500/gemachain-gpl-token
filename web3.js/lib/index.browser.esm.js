...
class Struct {
  ...
  encode() {
    return Buffer.from(serialize(GEMACHAIN_SCHEMA, this));
  }

  static decode(data) {
    return deserialize(GEMACHAIN_SCHEMA, this, data);
  }

  static decodeUnchecked(data) {
    return deserializeUnchecked(GEMACHAIN_SCHEMA, this, data);
  }
...
const GEMACHAIN_SCHEMA = new Map();
...
GEMACHAIN_SCHEMA.set(PublicKey, {
  kind: 'struct',
  fields: [['_bn', 'u256']]
}); // @ts-ignore
